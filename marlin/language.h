...
// LCD Menu Messages
	...
	#define MSG_CNG_SDCARD "Change SD-Card"
      // flyway add begin
      #define MSG_CP_STORE "Store Print Pos"
      #define MSG_CP_CONTINUE "Print From Last"
      //flyway add end
...
//flyway add begin china
#if LANGUAGE_CHOICE == 10

// LCD Menu Messages
	#define WELCOME_MSG "   OK.\xD7\xBC\xB1\xB8\xBE\xCD\xD0\xF7.."/* ARCH_ZDAUTO *///"\x33\x44\xD3\xD0\xC4\xBE\xD3\xD0\xD7\xBC\xB1\xB8\xBE\xCD\xD0\xF7"
	#define MSG_SD_INSERTED "\xBF\xA8\xD2\xD1\xB2\xE5\xC8\xEB"
	#define MSG_SD_REMOVED "\xBF\xA8\xD2\xD1\xB0\xCE\xB3\xF6"
	#define MSG_MAIN "\xD6\xF7\xB2\xCB\xB5\xA5"
	#define MSG_AUTOSTART "\xD7\xD4\xB6\xAF\xBF\xAA\xCA\xBC"
	#define MSG_DISABLE_STEPPERS "\xC7\xD0\xB6\xCF\xB5\xE7\xBB\xFA\xB9\xA9\xB5\xE7"
	#define MSG_AUTO_HOME "\xD7\xD4\xB6\xAF\xB9\xE9\xCE\xBB"
	#define MSG_SET_ORIGIN "\xC9\xE8\xD6\xC3\xD4\xAD\xB5\xE3"
	#define MSG_PREHEAT_PLA "PLA \xD4\xA4\xC8\xC8"
	#define MSG_PREHEAT_PLA_SETTINGS "PLA \xD4\xA4\xC8\xC8\xC9\xE8\xB6\xA8"
	#define MSG_PREHEAT_ABS "ABS \xD4\xA4\xC8\xC8"
	#define MSG_PREHEAT_ABS_SETTINGS "ABS \xD4\xA4\xC8\xC8\xC9\xE8\xB6\xA8"
	#define MSG_COOLDOWN "\xC0\xE4\xC8\xB4"
	#define MSG_SWITCH_PS_ON "Switch Power On"
	#define MSG_SWITCH_PS_OFF "Switch Power Off"
	#define MSG_EXTRUDE "\xBC\xB7\xB3\xF6"
	#define MSG_RETRACT "\xBB\xD8\xB3\xE9"
	#define MSG_MOVE_AXIS "\xB7\xD6\xD6\xE1\xCF\xF2\xD2\xC6\xB6\xAF"
	#define MSG_SPEED "\xCB\xD9\xB6\xC8"
	#define MSG_NOZZLE "\xC5\xE7\xD7\xEC"
	#define MSG_NOZZLE1 "\xC5\xE7\xD7\xEC2"
	#define MSG_NOZZLE2 "\xC5\xE7\xD7\xEC3"
	#define MSG_BED "\xB4\xF2\xD3\xA1\xB4\xB2"
	#define MSG_FAN_SPEED "\xB7\xE7\xC9\xC8\xCB\xD9\xB6\xC8"
	#define MSG_FLOW "\xC1\xF7\xB6\xAF\xC2\xCA"
	#define MSG_CONTROL "\xBF\xD8\xD6\xC6"
	#define MSG_MIN " \002 Min"
	#define MSG_MAX " \002 Max"
	#define MSG_FACTOR " \002 Fact"
	#define MSG_AUTOTEMP "\xD7\xD4\xB6\xAF\xBF\xD8\xCE\xC2"
	#define MSG_ON "\xBF\xAA "
	#define MSG_OFF "\xB9\xD8"
	#define MSG_PID_P "PID-P"
	#define MSG_PID_I "PID-I"
	#define MSG_PID_D "PID-D"
	#define MSG_PID_C "PID-C"
	#define MSG_ACC  "\xBC\xD3\xCB\xD9"
	#define MSG_VXY_JERK "Vxy-jerk"
	...
	#define MSG_ZSTEPS "Zsteps/mm"
	#define MSG_ESTEPS "Esteps/mm"
	#define MSG_RECTRACT "\xBB\xD8\xB3\xE9"
	#define MSG_TEMPERATURE "\xCE\xC2\xB6\xC8"
	#define MSG_MOTION "\xB6\xAF\xD7\xF7"
	#define MSG_STORE_EPROM "\xBC\xC7\xC2\xBC\xB5\xBD EPROM"
	#define MSG_LOAD_EPROM "\xB4\xD3 EPROM\xB6\xC1\xC8\xA1"
	#define MSG_RESTORE_FAILSAFE "\xD6\xD8\xC6\xF4"
	#define MSG_REFRESH "\xB8\xFC\xD0\xC2"
	#define MSG_WATCH "\xB9\xDB\xB2\xEC"
	#define MSG_PREPARE "\xD7\xBC\xB1\xB8"
	#define MSG_TUNE "\xB5\xF7\xD5\xFB"
	#define MSG_PAUSE_PRINT "\xD4\xDD\xCD\xA3\xB4\xF2\xD3\xA1"
	#define MSG_RESUME_PRINT "\xBC\xCC\xD0\xF8\xB4\xF2\xD3\xA1"
	#define MSG_STOP_PRINT "\xCD\xA3\xD6\xB9\xB4\xF2\xD3\xA1"
	#define MSG_CARD_MENU "\x53\x44\xC4\xBF\xC2\xBC"
	#define MSG_NO_CARD "SD\xBF\xA8  \xC3\xBB\xD3\xD0\xB2\xE5"
	#define MSG_DWELL "\xCB\xAF\xC3\xDF.."
	#define MSG_USERWAIT "\xB5\xC8\xB4\xFD\xD3\xC3\xBB\xA7"
	#define MSG_RESUMING "\xD5\xFD\xD4\xDA\xD0\xF8\xB4\xF2"
	#define MSG_NO_MOVE "\xB2\xBB\xB6\xAF"
	#define MSG_KILLED "\xC8\xA1\xCF\xFB. "
	#define MSG_STOPPED "\xCD\xA3\xD6\xB9. "
	#define MSG_CONTROL_RETRACT  "\xBB\xD8\xB3\xE9 mm"
	#define MSG_CONTROL_RETRACTF "\xBB\xD8\xB3\xE9  F"
	#define MSG_CONTROL_RETRACT_ZLIFT "\xCC\xF8\xD4\xBE mm"
	#define MSG_CONTROL_RETRACT_RECOVER "\xD6\xD8\xD6\xC3 +mm"
	#define MSG_CONTROL_RETRACT_RECOVERF "\xD6\xD8\xD6\xC3  F"
	#define MSG_AUTORETRACT "\xD7\xD4\xB6\xAF\xBB\xD8\xB3\xE9."
	#define MSG_FILAMENTCHANGE "\xBB\xBB\xC1\xCF"
	#define MSG_INIT_SDCARD "SD\xBF\xA8\xB3\xF5\xCA\xBC\xBB\xAF"	
	#define MSG_CNG_SDCARD "\xB8\xFC\xBB\xBBSD\xBF\xA8"
	    #define MSG_ZPROBE_ZOFFSET "Z Offset"
      // flyway add begin
      #define MSG_CP_STORE "\xBC\xC7\xC2\xBC\xB4\xF2\xD3\xA1\xCE\xBB\xD6\xC3"
      #define MSG_CP_CONTINUE "\xB4\xD3\xBC\xC7\xC2\xBC\xB4\xA6\xBC\xCC\xD0\xF8"
      //flyway add end
// Serial Console Messages
	...
	#define MSG_STEPPER_TOO_HIGH "Steprate to high: "
	#define MSG_ENDSTOPS_HIT "endstops hit: "
	#define MSG_ERR_COLD_EXTRUDE_STOP " cold extrusion prevented"
	#define MSG_ERR_LONG_EXTRUDE_STOP " too long extrusion prevented"
